// Future regional languages (Tamil, Telugu, Kannada, Marathi, Bengali, Gujarati) 
// can be added as new top-level keys with no structural changes required.

export const translations = {
  en: {
    // Ticket-specified voice phrases
    obstacleAhead: "Obstacle ahead",
    textDetected: "Text detected",
    doorLeft: "Door on the left",
    
    // Voice coach UI and prompts
    voiceCoach: "Voice Coach",
    speakWithConfidence: 'Speak with <span class="text-gradient-primary">Confidence</span>',
  ...
  hi: {
    // Ticket-specified voice phrases
    obstacleAhead: "आगे बाधा है",
    textDetected: "पाठ मिला",
    doorLeft: "दरवाज़ा बाईं ओर है",
    
    // Voice coach UI and prompts
    voiceCoach: "वॉयस कोच",
    speakWithConfidence: '<span class="text-gradient-primary">आत्मविश्वास</span> के साथ बोलें',
