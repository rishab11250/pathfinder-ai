 ...
 * If the extracted text is very short (e.g. less than 100 chars), it might be a scanned PDF.
 */
async function extractTextFromPDF(file, onProgress) {
  try {
    ...
    if (error?.name === "FakeWorkerConstructor") {
      throw new Error("Failed to initialize PDF worker. Please try again.");
    }
