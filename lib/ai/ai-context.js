import { sanitizePromptInput } from "@/lib/ai/prompt-safety";
...
/**
 * Builds a clean, industry-only context string for global insights.
 * This ensures no user-specific data (PII) leaks into cached industry insights.
 */
export function buildIndustryContext(industry) {
  return [
    "Industry Context:",
    `- Industry: ${normalizeValue(industry)}`,
  ].join("\n");
}
